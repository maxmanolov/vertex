...
| Show FPS / lagometer / debug diagnostics | Performance visibility | missing | Planned: log-based counters first (chunk updates/frame, immediate consumptions), HUD later. |
