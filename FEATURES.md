...
| Feature | Purpose | Vertex status | Notes |
|---|---|---|---|
| Connected textures (CTM) | Seamless glass/bookshelves etc. | **in progress** | Core merged and the shared icon dispatch is **verified reliable** (A/B measured, pack-independent - docs/OPEN-QUESTIONS.md). Unblocked: remaining work is the ruleset loader (pack-zip walking for arbitrary CTM file names), blob-class dispatch, and atlas calibration. |
